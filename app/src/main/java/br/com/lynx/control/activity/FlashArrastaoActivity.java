 ...
 */
public class FlashArrastaoActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (configuracao.getDivisaoID() == 2)
            toolbar.setTitle("Arrastão");
        else if (configuracao.getDivisaoID() == 9)
          toolbar.setTitle("MSL");
        ...
        lista = flashDAO.getFlashArrastao();
